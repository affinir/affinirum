...
describe('Expression Evaluation test', ()=> {
	[
		...
		[ '[a, b, c]->append([ 1, 2, 3, 4 ])->reduce(num(num acc,num val)(acc+val))', [ { a: 1, b: 2, c: 3, result: 16 } ] ],
		...
		[ 'a->compose(string (obj acc, str key) key->char(0))."a"', [ { a: [ 'a', 'b', 'c' ], result: 'a' }, { a: [ 'b', 'a' ], result: 'a' } ] ],
