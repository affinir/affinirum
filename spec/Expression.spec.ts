...
describe('Expression Evaluation test', ()=> {
	[
		...
		[ 'number s=0,range(start, end).map(void(number x)->s=s+x),s', [ { start: 1, end: 11, result: 55 }, { start: -1, end: -11, result: -65 } ] ],
		...
		[ '{a:a1+a2, "b": b1, c: "10", (a1 > 0) $ "  d".trim , "zz": 3, "p": 10}{p}', [ { a1: 1, a2: 2, b1: 'b', p: 'd', result: 3 }, { a1: -2, a2: 18, b1: 'bb', p: 'zz', result: 3 } ] ],
