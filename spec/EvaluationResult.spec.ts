...
describe('Evaluation Result test', ()=> {
	([
		...
		['123', [{ result: 123n }]],
		['#0.Format()', [{ result: '00' }]],
		['#ffff.Format', [{ result: 'ffff' }]],
		['#AAAA.Format()', [{ result: 'aaaa' }]],
		['#.Format()', [{ result: '' }]],
		['a.Format()', [{ a: new Uint8Array().buffer, result: '' }]],
		['""', [{ result: '' }]],
		['"0 "', [{ result: '0 ' }]],
		...
		['#ffff0001.Slice(1).Format', [{ result: 'ff0001' }]],
		...
		['Array.Join([[10]], [4], [12])[0]', [{ result: 10n }]],
