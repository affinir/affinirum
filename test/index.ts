...
[
	...
	[ 'v.contains(str, pos, true)', [ { v: "", str: "", pos: undefined, result: true }, { v: "", str: "123", pos: 0, result: false },
		{ v: "  ab CD  0123   ", str: " A Bcd ", result: true }, { v: "  ab C-D  0123   ", str: " A+Bcd ", result: true } ] ],
	[ 'v.startsWith(str, pos, true)', [ { v: "", str: "", pos: undefined, result: true }, { v: "", str: "123", pos: 0, result: false },
		{ v: "  ab CD  0123   ", str: " A++Bcd ", pos: undefined, result: true }, { v: "ab CD  0123   ", str: "abcd", pos: 2, result: false } ] ],
	[ 'v.endsWith(str, pos, true)', [ { v: "", str: "", pos: undefined, result: true }, { v: "", str: "123", pos: 0, result: false },
		{ v: " ab CD  01+2+ 3 ", str: " 0123 ", pos: undefined, result: true }, { v: " abcdeeeeeef 123", str: "123", pos: 7, result: false } ] ],
	...
	[ '[p,11].map(number?(number a)=>t:10,switch(a>10,t,null))[i]', [ { i: 1, p: 10, result: 10 }, { i: 0, p: 1, result: undefined } ] ],
	...
	[ 'x:arr.any(boolean(number a)=>a<0),b:c,x&b', [ { arr: [ 0, -1 ], c: true, result: true } ] ],
	...
	[ 'a:myvar/3,b:mv*2,a/b', [ { myvar: 6, mv: 1, result: 1 }, { myvar: 30, mv: 5, result: 1 } ] ],
