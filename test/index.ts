...
[
	...
	[ '"  abcd  0123  !".unlike("abcd-00123")', [ { result: true } ] ],
	[ '"  abCD  0123   " *~* " ABcd "', [ { result: true } ] ],
	[ '"  abCD  0123   " ~* " ABcd"', [ { result: true } ] ],
	[ '"  abCD  0123   ".beginsLike(" ABcd ", 2)', [ { result: true } ] ],
	[ '"  abCD  0123      ".endsLike(" 0123 ", 15)', [ { result: true } ] ],
	...
	[ '`abc def abc` *=* str', [ { str: 'abc', result: true }, { str: 'aaa', result: false } ] ],
