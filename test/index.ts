...
[
	...
	[ '[0,1][2]?=5', [ { result: 5 } ] ],
	[ '"   Abcd  0123  !" ~ "abcd-0123 "', [ { result: true } ] ],
	[ '"  abcd  0123  !" !~ "abcd-00123  "', [ { result: true } ] ],
	[ '"  abcd  0123  !".nlike("abcd-00123  ")', [ { result: true } ] ],
	[ '`abc def abc`.contains(str)', [ { str: 'abc', result: true }, { str: 'aaa', result: false } ] ],
	[ '"  abCD  0123   ".contains(" ABcd ", 0, true)', [ { result: true } ] ],
	[ '"  abCD  0123   ".beginsWith(" ABcd ", pos, true)', [ { pos: 0, result: true }, { pos: 2, result: true } ] ],
	[ '"  abCD  0123      ".endsWith(" 0123 ", 15, true)', [ { result: true } ] ],
	[ 'a = b', [ { a: 1, b: '1', result: false }, { a: 1, b: 1, result: true } ] ],
	[ 'a != b', [ { a: 1, b: '1', result: true }, { a: 1, b: 1, result: false } ] ],
	...
	[ '[p,11].map(number?(number a)=>switch(a>10,10,null))[1]', [ { p: 10, result: 10 } ] ],
