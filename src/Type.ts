...
export const typeLogical = new Type('boolean', 'array');
export const typeNumerical = new Type('number', 'array');
export const typeStreamable = new Type('buffer', 'array');
export const typeTextual = new Type('string', 'array');
...
export const typeReal = new Type('boolean', 'number', 'buffer', 'string', 'array', 'object', 'function');
