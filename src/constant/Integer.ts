...
const funcEncodeInteger = new Constant(
	(value: bigint, encoding: 'int8' | 'int16' | 'int16le' | 'int32' | 'int32le'
...
const funcDecodeInteger = new Constant(
	(value: ArrayBuffer, encoding: 'int8' | 'int16' | 'int16le' | 'int32' | 'int32le'
			| 'uint8' | 'uint16' | 'uint16le' | 'uint32' | 'uint32le'
			| 'int64' | 'int64le' | 'uint64' | 'uint64le', byteOffset?: bigint)=> {
		if (value == null) {
			return undefined;
		}
