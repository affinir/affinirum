import { funcAt, funcAtValid, funcBy, funcByValid, funcLen } from './ExpressionFunctionAccess.js';
...
export const operAtValid = funcAtValid.clone();
export const operBy = funcBy.clone();
export const operByValid = funcByValid.clone();
